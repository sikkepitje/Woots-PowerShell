...
# -------- Courses classes --------
Function Get-WootsCourseCoursesClasse($id) { return Get-WootsResourceItem -resource "courses" -id $id -itemtype "courses_classes"}
Function Get-WootsClassCoursesClasse($id) { return Get-WootsResourceItem -resource "classes" -id $id -itemtype "courses_classes"}
Function Add-WootsCourseCoursesClasse($id,$Parameter) {return Add-WootsResourceItem -resource "courses" -id $id -itemtype "courses_classes" -parameter $Parameter}
Function Add-WootsClassCoursesClasse($id,$Parameter) {return Add-WootsResourceItem -resource "classes" -id $id -itemtype "courses_classes" -parameter $Parameter}
Function Remove-WootsCoursesClasse($id) {return Remove-WootsResource -resource "courses_classes" -id $id}
# -------- Courses users --------
